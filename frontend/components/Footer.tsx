      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-yellow-400 mb-4">LifeScore</h3>
            <p className="text-gray-400 mb-4">
              The Global Proof of Real Ability. Revolutionizing how the world measures and verifies real skills.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-yellow-400 transition">Features</a></li>
              <li><a href="#" className="text-gray-400 hover:text-yellow-400 transition">Pricing</a></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 LifeScore. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
